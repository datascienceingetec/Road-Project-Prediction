...
from .unidades_funcionales import unidades_funcionales_bp
...
def register_v1_blueprints(app):
    ...
    api_v1.register_blueprint(unidades_funcionales_bp, url_prefix="/unidades-funcionales")
    ...
    api_v1.register_blueprint(charts_bp, url_prefix="/charts")
