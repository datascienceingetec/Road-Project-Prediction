...
from app.adapters.storage import StorageProtocol
...
class LegacyModelAdapter(ModelAdapterInterface):
    ...
    def __init__(self, storage: StorageProtocol):
        ...
        Args:
            storage: Storage protocol implementation
        """
    ...
    def _map_fase_id_to_code(self, fase_id: int) -> str:
        ...
        raise ValueError(
            f"Fase '{fase.nombre}' no está soportada para predicciones.")
    ...
    def get_comparison_data(self, fase_id: int, item_name: str) -> dict[str, Any]:
        ...
        if not item_column:
            raise ValueError(
                f"Item '{item_name}' not found in historical data")
    ...
    def _train_models_legacy(self, fase: str) -> dict[str, Any]:
        ...
        if fase == 'III':
            ...
            raise NotImplementedError(
                f"Fase '{fase}' training not yet implemented")
        else:
    ...
    def _save_models_legacy(self, fase: str, models: dict[str, Any], metadata: Optional[dict] = None, summary_df=None) -> str:
        """
        Save trained models to storage as pickle.
        """
        ...
        try:
            ...
            return self.storage.save(filename, data_bytes)
    ...
    def _load_models_legacy(self, fase: str) -> Optional[dict[str, Any]]:
        ...
        try:
            ...
            data_bytes = self.storage.load(filename)
